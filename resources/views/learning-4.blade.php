...
<div class="card shadow-lg mx-4 card-profile-top">
  ...
  <div class="container-fluid py-4">
    <div class="row">
        <div class="col-md-8">
            {{-- Get Topic link theo Topicid --}}
                {{-- {{$topic->topicname}} --}}
                <iframe width="100%" height="500" src="{{$topic->link}}?controls=0&ampmodestbranding=0&amprel=0" autoplay=1 ></iframe>
            <div class="row">
                <div class="col-md-12">
                  ...
                  <ul class="list-group">
                       ...
                       <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                           ...
                           <div class="d-flex align-items-center text-sm">
                               <span class="me-2 text-success font-weight-bold">{{$item->trainer}}</span>
                               <a class="btn btn-link text-info text-sm mb-0 px-0 ms-4" href="/mycourse/{{$item->courseid}}/Lab={{$item->topicid}}"><i class="fa-solid fa-clapperboard"></i>  &nbsp; View Course</a>
                           </div>
                       </li>
                       @endforeach
                  </ul>
